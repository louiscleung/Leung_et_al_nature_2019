function [] = ViewpointFigMode4(dirname,excel,needTotalBoxBool,rowBool,vpWake,...
...
vpTestWake2 = vpWake(:,13:18);
vpTestWake3 = vpWake(:,19:24);
%Sleep
vpConSleep1 = vpSleep(:,1:6);
vpTestSleep1 = vpSleep(:,7:12);
vpTestSleep2 = vpSleep(:,13:18);
vpTestSleep3 = vpSleep(:,19:24);
...
vpTestWake3M = nanmean(vpTestWake3,2);
std_3 = nanstd(vpConWake1')';
std_4 = nanstd(vpTestWake1')';
std_5 = nanstd(vpTestWake2')';
std_6 = nanstd(vpTestWake3')';
vpConWake1S = std_3./sqrt(size(vpConWake1,2));
vpTestWake1S = std_4./sqrt(size(vpTestWake1,2));
vpTestWake2S = std_5./sqrt(size(vpTestWake2,2));
vpTestWake3S = std_6./sqrt(size(vpTestWake3,2));
%zscore
...
vpTestSleep3Z = bsxfun(@rdivide, bsxfun(@minus, vpTestSleep3, nanmean(vpTestSleep3,1)), nanstd(vpTestSleep3,0,1));

vpConSleep1ZM = nanmean(vpConSleep1Z,2);
vpTestSleep1ZM = nanmean(vpTestSleep1Z,2);
vpTestSleep2ZM = nanmean(vpTestSleep2Z,2);
vpTestSleep3ZM = nanmean(vpTestSleep3Z,2);
...
%wake
rowColors{3,1} = [0.1,0.5,1.0];
%Sleep
rowColors{3,2} = [1.0,0.5,0.0];
%wake
rowColors{4,1} = [0.0,0.6,0.0];
%Sleep
rowColors{4,2} = [1.0,0.8,0.1];
%Patch color
patchColor = [1 1 0.8];
...
set(gca,'XTickLabel',{' '})
set(gca,'FontSize',8)
axis(gca,[0 (size(vpTestWake3,2)+1) 0 yscale])
ylabel('Activity (sec/min)')
...
nanviewpointData2 = vpConSleep1;
nanviewpointData2(nanviewpointData2==0) = nan;
b5 = boxplot(nanviewpointData2);
%boxplot properties
...
nanviewpointData5 = vpTestSleep1;
nanviewpointData5(nanviewpointData5==0) = nan;
b6 = boxplot(nanviewpointData5);
%boxplot properties
...
subplot(6,4,7)
nanviewpointData6 = vpTestSleep2;
nanviewpointData6(nanviewpointData6==0) = nan;
b7 = boxplot(nanviewpointData6);
%boxplot properties
...
subplot(6,4,8)
nanviewpointData7 = vpTestSleep3;
nanviewpointData7(nanviewpointData7==0) = nan;
b8 = boxplot(nanviewpointData7);
%boxplot properties
...
set(gca,'XTickLabel',{' '})
set(gca,'FontSize',8)
axis(gca,[0 (size(vpTestSleep3,2)+1) 0 yscale2])
ylabel('Sleep (min/10min)')
...
if (vpTestWake2S==std_5)
    plot(vpTestWake2M,'linewidth',0.5, 'color', rowColors{3,1});
else
    shadedErrorBar([],vpTestWake2M',vpTestWake2S,{'linestyle','-','color', rowColors{3,1}},0);
end

hold on

if (vpTestWake3S==std_6)
    plot(vpTestWake3M,'linewidth',0.5, 'color', rowColors{4,1});
else
    shadedErrorBar([],vpTestWake3M',vpTestWake3S,{'linestyle','-','color', rowColors{4,1}},0);
end
hold on
...
if (vpTestSleep2S==std_9)
    plot(vpTestSleep2M,'linewidth',0.5, 'color', rowColors{3,2}); %'r'
else
    shadedErrorBar([],vpTestSleep2M',vpTestSleep2S,{'linestyle','-','color', rowColors{3,2}},0);
end
hold on

if (vpTestSleep3S==std_10)
    plot(vpTestSleep3M,'linewidth',0.5, 'color', rowColors{4,2}); %'r'
else
    shadedErrorBar([],vpTestSleep3M',vpTestSleep3S,{'linestyle','-','color', rowColors{4,2}},0);
end
hold on
...
hold on;
plot(vpTestWake2M,'linewidth',0.75, 'color', rowColors{3,1});
hold on;
plot(vpTestWake3M,'linewidth',0.75, 'color', rowColors{4,1});
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale; startTreat2 yscale],...
          'FaceColor',patchColor, 'EdgeColor',patchColor,'FaceAlpha',0.3);
...
set(gca,'FontSize',8)
axis(gca, [0 inf 0 yscale])
lx1 = legend (rowLabels(1,1:4),'Location','northeast');
set(lx1,'FontSize',4)
legend('boxoff');
...
hold on;
plot(vpTestWake2ZM,'linewidth',0.75, 'color', rowColors{3,1});
hold on;
plot(vpTestWake3ZM,'linewidth',0.75, 'color', rowColors{4,1});
hold on
if ~isempty(startTreat2)
...
set(gca,'FontSize',8)
axis(gca, [0 inf -2 5])
lx2 = legend (rowLabels(1,1:4),'Location','northeast');
set(lx2,'FontSize',4)
legend('boxoff');
...
hold on;
plot(vpTestSleep2M,'linewidth',0.75, 'color', rowColors{3,2});
hold on;
plot(vpTestSleep3M,'linewidth',0.75, 'color', rowColors{4,2});
hold on
...
set(gca,'FontSize',8)
axis(gca, [0 inf 0 yscale2])
lx3 = legend (rowLabels(1,1:4),'Location','northeast');
set(lx3,'FontSize',4)
legend('boxoff');
ylabel('Abs. Sleep (min/10min)')
...
hold on;
plot(vpTestSleep2ZM,'linewidth',0.75, 'color', rowColors{3,2});
hold on;
plot(vpTestSleep3ZM,'linewidth',0.75, 'color', rowColors{4,2});
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 -2; endTreat2 -2; endTreat2 5; startTreat2 5],...
          'FaceColor',patchColor, 'EdgeColor',patchColor,'FaceAlpha',0.3);
...
set(gca,'FontSize',8)
axis(gca, [0 inf -2 5])
lx4 = legend (rowLabels(1,1:4),'Location','northeast');
set(lx4,'FontSize',4)
legend('boxoff');
...
vpBoxarranged(1:6,3) = vpBoxdata(13:18,1);
vpBoxarranged(1:6,4) = vpBoxdata(19:24,1);
%Day Sleep
vpBoxarranged(1:6,5) = vpBoxdata(1:6,2);
vpBoxarranged(1:6,6) = vpBoxdata(7:12,2);
vpBoxarranged(1:6,7) = vpBoxdata(13:18,2);
vpBoxarranged(1:6,8) = vpBoxdata(19:24,2);
%Night Activity
vpBoxarranged(1:6,9) = vpBoxdata(1:6,3);
vpBoxarranged(1:6,10) = vpBoxdata(7:12,3);
vpBoxarranged(1:6,11) = vpBoxdata(13:18,3);
vpBoxarranged(1:6,12) = vpBoxdata(19:24,3);
%Night Sleep
vpBoxarranged(1:6,13) = vpBoxdata(1:6,4);
vpBoxarranged(1:6,14) = vpBoxdata(7:12,4);
vpBoxarranged(1:6,15) = vpBoxdata(13:18,4);
vpBoxarranged(1:6,16) = vpBoxdata(19:24,4);
...
if (needTotalBoxBool)
    ...
    endRow = rowBool;
    subplot(6,4,21)
    b9 = boxplot(vpBoxarranged(:,startRow:endRow),'Labels',{rowLabels(1,1:4)});
    %boxplot properties
    ...
    b10 = boxplot(vpBoxarranged(:,startRow1:endRow1),'Labels',{rowLabels(1,1:4)});
    %boxplot properties
    ...
    b11 = boxplot(vpBoxarranged(:,startRow2:endRow2),'Labels',{rowLabels(1,1:4)});
    %boxplot properties
    ...
    b12 = boxplot(vpBoxarranged(:,startRow3:endRow3),'Labels',{rowLabels(1,1:4)});
    %boxplot properties
    ...
    fileName_2 = 'Plate_All.eps';
    print('-depsc','-r300',[outputdir,filesep,fileName_2]);
    close(hh);
else
    set(hh, 'color', 'w');
    fileName = 'Plate_All.tif';
...
%% Second figure with individual comparisons
hh2 = figure('Position', [10, 10, 1000, 800]);
...
hold on
if (vpTestWake1S==std_4)
    plot(vpTestWake1M,'linewidth',0.5, 'color', [0.0,0.0,0.5]);
else
    shadedErrorBar([],vpTestWake1M',vpTestWake1S,{'linestyle','-','color', [0.0,0.0,0.5]},0);
end
hold on
...
axis(gca, [0 inf 0 yscale])
ylabel('Abs. Activity (sec/10min)')
title1 = strcat(rowLabels(1,1),' vs ',{' '}, rowLabels(1,2));
title(title1)
...
if (vpTestSleep1S==std_8)
    plot(vpTestSleep1M,'linewidth',0.5, 'color', [0.7,0.0,0.0]); %'r'
else
    shadedErrorBar([],vpTestSleep1M',vpTestSleep1S,{'linestyle','-','color', [0.7,0.0,0.0]},0);
end
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale2; startTreat2 yscale2],...
...
hold on
if (vpTestWake2S==std_4)
    plot(vpTestWake2M,'linewidth',0.5, 'color', [0.0,0.0,0.5]);
else
    shadedErrorBar([],vpTestWake2M',vpTestWake2S,{'linestyle','-','color', [0.0,0.0,0.5]},0);
end
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale; startTreat2 yscale],...
...
axis(gca, [0 inf 0 yscale])
ylabel('Abs. Activity (sec/10min)')
title2 = strcat(rowLabels(1,1),' vs ',{' '}, rowLabels(1,3));
title(title2)
...
if (vpTestSleep2S==std_8)
    plot(vpTestSleep2M,'linewidth',0.5, 'color', [0.7,0.0,0.0]); %'r'
else
    shadedErrorBar([],vpTestSleep2M',vpTestSleep2S,{'linestyle','-','color', [0.7,0.0,0.0]},0);
end
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale2; startTreat2 yscale2],...
...
if (vpTestWake1S==std_4)
    ...
    shadedErrorBar([],vpTestWake3M',vpTestWake3S,{'linestyle','-','color', [0.0,0.0,0.5]},0);
end
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale; startTreat2 yscale],...
...
axis(gca, [0 inf 0 yscale])
ylabel('Abs. Activity (sec/10min)')
title3 = strcat(rowLabels(1,1),' vs ',{' '}, rowLabels(1,4));
title(title3)
...
if (vpTestSleep3S==std_8)
    plot(vpTestSleep1M,'linewidth',0.5, 'color', [0.7,0.0,0.0]); %'r'
else
    shadedErrorBar([],vpTestSleep3M',vpTestSleep3S,{'linestyle','-','color', [0.7,0.0,0.0]},0);
end
hold on
if ~isempty(startTreat2)
    patch('Faces',[1 2 3 4],'Vertices',[startTreat2 0; endTreat2 0; endTreat2 yscale2; startTreat2 yscale2],...
...
title(title3)
set(hh2, 'color', 'w');
fileName2 = 'Plate_individual.tif';
export_fig([outputdir,fileName2], '-r500','-nocrop','-a2'); 
fileName3b = 'Plate_individual.eps';
print('-depsc','-r300',[outputdir,filesep,fileName3b]);
close(hh2);
%%save out
